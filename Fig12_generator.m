...
My_ar=[12 16]; % number of LIS reflecting elements across the y axis
Mz_ar=[12 16]; % number of LIS reflecting elements across the z axis
M_bar=8; % number of active elements
K_DL=64; % number of subcarriers as input to the Deep Learning model
Training_Size=[2, 1000, 2000, 3000, 4000]; % Training Dataset Size vector
